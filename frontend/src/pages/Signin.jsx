  ...
  const signinContent = (
    <div className="relative w-full min-h-screen bg-[#030305] flex items-center justify-center p-4 overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-[1000px] min-h-[620px] rounded-3xl overflow-hidden flex flex-col md:flex-row shadow-[0_0_50px_rgba(139,92,246,0.15)] border border-white/5"
      ...
      >
        ...
        <div className="relative w-full md:w-[45%] min-h-[250px] md:min-h-full overflow-hidden">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 0.6 }} className="absolute bottom-8 left-8 right-8">
            <h2 className="text-white text-3xl md:text-4xl font-bold leading-tight mb-3" style={{ fontFamily: 'Outfit, sans-serif' }}>
              Your AI-Powered<br />
              <span style={{ background: 'linear-gradient(90deg, #a78bfa, #c084fc, #e879f9)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Companion</span>
            </h2>
            <p className="text-sm md:text-base leading-relaxed max-w-[300px]" style={{ color: 'rgba(255,255,255,0.6)' }}>
              Intelligent conversations, personalized just for you. Get started now.
            </p>
          </motion.div>
        </div>
        ...
        <div className="w-full md:w-[55%] flex flex-col items-center justify-center px-6 sm:px-10 md:px-14 py-10 md:py-8 bg-[#0f0f1a]">
          ...
          <div className="mb-10 flex gap-8 border-b border-white/10 w-full max-w-[420px]">
            ...
            <button onClick={() => navigate("/signup")} className="pb-3 text-sm font-medium text-white/40 hover:text-white/80 transition-colors bg-transparent border-none cursor-pointer">
              Sign Up
            </button>
          </div>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="text-center mb-10 w-full max-w-[420px]">
            <h1 className="text-white text-3xl font-bold mb-3 tracking-tight" style={{ fontFamily: 'Outfit, sans-serif' }}>Welcome Back</h1>
            <p className="text-sm tracking-wide" style={{ color: 'rgba(255,255,255,0.4)' }}>Sign in to continue your journey</p>
          </motion.div>
          ...
          <motion.form initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}
            ...
            <div className="flex justify-end mb-1">
              <button type="button" className="text-xs text-violet-400/60 hover:text-violet-400 transition-colors bg-transparent border-none cursor-pointer">
                Forgot Password?
              </button>
            </div>
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }}
            className="mt-8 text-sm" style={{ color: 'rgba(255,255,255,0.3)', fontFamily: 'Outfit, sans-serif' }}>
            Don't have an account?{' '}
            <span className="cursor-pointer font-semibold" style={{ color: '#a78bfa' }} onClick={() => navigate("/signup")}
