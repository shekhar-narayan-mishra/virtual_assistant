    ...
    const handleUpdateAssistant = async () => {
        ...
        try {
            if (userData?._id === "guest") {
                ...
                // Note: frontendImage is not defined in the provided context.
                // Assuming `selectedImage` itself holds the URL or a base64 string for guest mode.
                // If `selectedImage` is literally "input", then `frontendImage` would be needed.
                // For now, I'll use `selectedImage` directly as the image source for guest.
                const updatedGuest = {
                    ...userData,
                    assistantName: assistantName,
                    assistantImage: selectedImage // Use selectedImage directly for guest mode
                };
